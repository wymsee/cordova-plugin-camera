...
+ (instancetype) createFromTakePictureArguments:(CDVInvokedUrlCommand*)command
{
    ...
    pictureOptions.cameraFlashMode = [[command argumentAtIndex:12 withDefault:@(UIImagePickerControllerCameraFlashModeAuto)] unsignedIntegerValue];
...
+ (instancetype) createFromPictureOptions:(CDVPictureOptions*)pictureOptions;
{
    ...
    cameraPicker.cameraFlashMode = pictureOptions.cameraFlashMode;
